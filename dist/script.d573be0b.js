...
},{"core-js/library/fn/parse-float":"node_modules/core-js/library/fn/parse-float.js"}],"js/flourish-embed.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createFlourishStory = void 0;

var _parseFloat2 = _interopRequireDefault(require("@babel/runtime-corejs2/core-js/parse-float"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var BASE_URL = 'https://public.flourish.studio/';
...
var createFlourishStory = function createFlourishStory(storyId) {
  var slide = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var flourishEmbed = document.querySelector("[data-src=\"".concat(storyId, "\"]"));
  var existingIframe = document.querySelector('iframe');

  if (existingIframe && existingIframe.src.includes(storyId)) {
    var _embedUrl = "".concat(BASE_URL).concat(storyId, "/embed").concat(slide ? "#slide-".concat(slide) : '');

    existingIframe.src = _embedUrl;
    return;
  }

  var embedUrl = "".concat(BASE_URL).concat(storyId, "/embed").concat(slide ? "#slide-".concat(slide) : '');
  var chartWidth = flourishEmbed.getAttribute('data-width');
  var chartHeight = flourishEmbed.getAttribute('data-height');
  ...
  chartWidth ? iframe.style.width = chartWidth : isSafari() ? iframe.style.width = flourishEmbed.offsetWidth + 'px' : iframe.style.width = '100%';
  chartHeight && ('%' === chartHeight.charAt(chartHeight.length - 1) && (chartHeight = (0, _parseFloat2.default)(chartHeight) / 100 * flourishEmbed.parentNode.offsetHeight + 'px'), iframe.style.height = chartHeight);
};

exports.createFlourishStory = createFlourishStory;
},{"@babel/runtime-corejs2/core-js/parse-float":"node_modules/@babel/runtime-corejs2/core-js/parse-float.js"}],"js/scroller.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initScroller = void 0;

var _flourishEmbed = require("./flourish-embed");
...
var initScroller = function initScroller() {
  ...
  var step = article.selectAll('.step'); // initialize the scrollama
  ...
  function handleResize() {
    ...
    var figureHeight = window.innerHeight / 2; // var figureMarginTop = (window.innerHeight - figureHeight) / 2;

    var figureMarginTop = 0;
    figure.style('height', figureHeight + 'px').style('top', figureMarginTop + 'px'); // 3. tell scrollama to update new element dimensions
  ...
  function handleStepEnter(response) {
    ...
    (0, _flourishEmbed.createFlourishStory)('story/52937', response.index + 1);
  }
...
},{"./flourish-embed":"js/flourish-embed.js"}],"js/script.js":[function(require,module,exports) {
"use strict";
...
var STORY_ID = '52937';
(0, _flourishEmbed.createFlourishStory)("story/".concat(STORY_ID));
(0, _scroller.initScroller)();
},{"./scroller":"js/scroller.js","./flourish-embed":"js/flourish-embed.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
